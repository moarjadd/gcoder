// Legacy browser-side STL to G-code converter.
// The backend is the official source for conversion; keep this only as
// historical/fallback code until it can be safely removed.
